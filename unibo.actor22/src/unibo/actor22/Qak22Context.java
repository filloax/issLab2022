...
public class Qak22Context {
    private static final HashMap<String, QakActor22> ctxMap = new HashMap<String, QakActor22>();
    private static final HashMap<String, ProxyAsClient> proxyMap = new HashMap<String, ProxyAsClient>();
