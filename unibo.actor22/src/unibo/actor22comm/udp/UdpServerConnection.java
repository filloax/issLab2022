...
public class UdpServerConnection extends UdpConnection {
    private final Map<UdpEndpoint, UdpServerConnection> connMap;

    //producer/consumer syncronization
    private DatagramPacket packet = null;
    private final Semaphore waitToEnterNewPacket = new Semaphore(1); //handle() waits until a packet is still waiting for being processed
    private final Semaphore waitToConsumeNewPacket = new Semaphore(0); //receiveMsg() waits until a packet have arrived
