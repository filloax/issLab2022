...
public class ApplData {
    ...
    public static final String moveBackward(int duration) {
        return crilCmd("moveBackward", duration);
    }

    public static final String turnLeft(int duration) {
        return crilCmd("turnLeft", duration);
    }

    public static final String turnRight(int duration) {
        return crilCmd("turnRight", duration);
    }

    public static final String stop(int duration) {
        return crilCmd("alarm", duration);
    }

    public static final String stop() {
        return crilCmd("alarm", 10);
    }
