...
public class HIController {
    ...
    private IApplMessage moveAril(String cmd) {
        ...
        switch (cmd) {
            case "w":
                return CommUtils.buildDispatch("webgui", robotCmdId, "w", robotName);
            case "s":
                return CommUtils.buildDispatch("webgui", robotCmdId, "s", robotName);
            case "a":
                return CommUtils.buildDispatch("webgui", robotCmdId, "a", robotName);
            case "d":
                return CommUtils.buildDispatch("webgui", robotCmdId, "d", robotName);
            case "h":
                return CommUtils.buildDispatch("webgui", robotCmdId, "h", robotName);
            case "start":
                return CommUtils.buildDispatch("webgui", robotCmdId, "start", robotName);

            case "stop":
                return CommUtils.buildDispatch("webgui", "stop", "do", robotName);
            case "resume":
                return CommUtils.buildDispatch("webgui", "resume", "do", robotName);
            default:
                return CommUtils.buildDispatch("webgui", robotCmdId, "h", robotName);
        }
    }
